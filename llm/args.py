...
def get_parser():
    ...
    parser.add_argument("--cos_cycle_iters", type=int, default=18000, help="Number of cos cycle iterations")
    parser.add_argument(
        "--device",
        type=str,
        default="cuda:0",
    ...
    parser.add_argument(
        "--valid_source_file",
        type=str,
        default="TinyStoriesV2-GPT4-valid.txt",
    ...
    parser.add_argument("--temprature", type=float, default=0.9, help="temprature")
    parser.add_argument("--top_p", type=float, default=0.8, help="Inferencing top_p kernel search")
    return parser
